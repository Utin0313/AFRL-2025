...
# Configuration 1
print("Settting Amplitude (0.7, 0.5, 0.3): ")
xmlrpc_control.set_amp0(0.7) # Set filter config
xmlrpc_control.set_amp1(0.5) # Set filter config
xmlrpc_control.set_amp2(0.3) # Set filter config
time.sleep(t_pause)
...
# Configuration 2
print("Settting Amplitude (0.2, 0.4, 0.6): ")
xmlrpc_control.set_amp0(0.2) # Set filter config
xmlrpc_control.set_amp1(0.4) # Set filter config
xmlrpc_control.set_amp2(0.6) # Set filter config
time.sleep(t_pause)
P_avg = zmq_measure(socket1,PRINT_MEASUREMENTS)
print(f"  Current Prediction: {P_avg:.4}")
time.sleep(t_pause)
